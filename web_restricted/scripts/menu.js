...
async function getFavOrders() {
    ...
    if (response.ok) { 
        ...
        for(let i = 0; i < json.orders.length; i++) {
            ...
            .append($("<button class='btn btn-danger' style='margin-left: 3em;' onclick='removeFavItem("+json.orders[i].favpizzaid+")' type='button'>REMOVE</button>")))            
        }
...
async function getPrevOrders() {
    ...
    if (response.ok) { 
        ...
        for(let i = 0; i < json.orders.length; i++) {
            ...
            .append($("<button class='btn btn-danger' style='margin-left: 3em;' onclick='removePrevItem("+json.orders[i].orderid+")' type='button'>REMOVE</button>")))
        }
